...
const BOOLEAN_FLAGS = new Set(["background", "diff", "json", "all", "details", "health", "guide", "static", "agentic", "write", "isolate", "sequential", "set-baseline", "release", "force", "purge", "reset", "yes", "export", "adversarial", "help"]);
