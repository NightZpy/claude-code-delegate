...
export function formatQuotaAlertLine(provider, status) {
  ...
  return `${icon} cc-delegate quota alert: ${provider} ${verb} ${Math.round(status.pct)}% of ${formatUsd2(status.monthlyUsd)} monthly quota (${formatUsd2(status.spentThisMonth)} spent)`;
}
